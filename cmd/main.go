...
import (
	...
	"github.com/thakurnishu/homelab-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3861bb02.homelab.nishantlabs.cloud",
	...
	if err = (&controller.MinimalDoReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "MinimalDo")
		os.Exit(1)
	}
